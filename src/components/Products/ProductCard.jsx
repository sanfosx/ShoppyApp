...
const confirmAddToCart = () => {
  ...
  swalWithBootstrapButtons
    .fire({
      title: "Lo quieres?",
      text: "El producto sera agregado al carrito de compras!",
      icon: "question",
    ...
    .then((result) => {
      if (result.isConfirmed) {
        ...
        swalWithBootstrapButtons.fire({
          title: "Cancelado...",
          text: "El producto no se ha agregado al carrito",
          icon: "error",
        });
      }
    });
      ...
      <div className="row g-0">
        <div className="col-md-6">
          <img
            ...
            className="img-fluid rounded m-2 product-image"
            alt="..."
          />
        </div>
        <div className="col-md-6">
          <div className="card-body d-flex flex-column justify-content-around product-card-body mx-3 px-2 py-4 my-3">
            ...
            <div className="d-flex justify-content-between">
              ...
              <button
                className="btn btn-primary" onClick={() => confirmAddToCart()}> Lo Quiero</button>
            </div>
          </div>
        </div>
      </div>
